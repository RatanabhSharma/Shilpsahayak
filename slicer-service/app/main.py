...
def process_slicing_job(job_id: str, file_path: str, params: Dict[str, Any]):
    ...
    try:
        ...
        JOBS[job_id]["result"] = {
            ...
            "classification": insp.get("classification", "geometry_bearing_project"),
            "dimensions": dims,
            "filament_grams": filament_grams,
            "filament_mm": filament_mm,
            "print_time_seconds": stats.get("print_time_seconds", 0),
            "raw_time_string": stats.get("raw_time_string", ""),
            "profile_id": os.path.basename(profile_path).replace(".ini", ""),
            "profileApplied": os.path.basename(profile_path),
            "profileVersion": "2026-09-07-v1",
            "profile_version": "2026-09-07-v1",
            "printer_id": "bambu_production",
            "activeEnvelope": active_envelope,
            "active_envelope": active_envelope,
            "weight_source": quote.get("weightSource", "slicer_grams"),
            "weightSource": quote.get("weightSource", "slicer_grams"),
