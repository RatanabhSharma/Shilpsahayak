...
export function Cart() {
  ...
  /*
   * Custom prints use their calculated custom price.
   * Normal products continue using product.price.
   */
  const getItemPrice = (
      ...
      ">
        ...
        ">
          ...
          {cart.map((item) => {
            ...
            /*
             * Every cart item has its own identity.
             */
            const cartItemId =
              getCartItemId(item);
                      ...
                      {item.customPrint && (
                        ...
                        ">
                          ...
                          ">
                            ...
                            {item.customPrint.estimatedWeight !== undefined && (
                              <p className="text-charcoal-light">
                                Weight:{' '}
                                <span className="text-charcoal">
                                  {
