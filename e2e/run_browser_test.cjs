...
(async () => {
  ...
  try {
    ...
    const testFile = path.join(__dirname, '../slicer-service/app/storage/db431ce4-a949-46aa-a4e6-f21461f7c124_Stitchxpikachu.3mf');
    ...
    await page.screenshot({ path: path.resolve('../scratch/outputs/browser_unscaled_success.png') });
    console.log('Saved screenshot: ../scratch/outputs/browser_unscaled_success.png');
    ...
    await page.screenshot({ path: path.resolve('../scratch/outputs/browser_scaled_exceeds.png') });
    console.log('Saved screenshot: ../scratch/outputs/browser_scaled_exceeds.png');
